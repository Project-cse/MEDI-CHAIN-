  ...
  return (
    <div className='w-full bg-gradient-to-br from-gray-50 to-white p-4 sm:p-6 mobile-safe-area pb-6 min-h-full'>
      <div className='max-w-2xl mx-auto space-y-4'>
        <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 page-header-row'>
          <div>
            <h1 className='text-xl sm:text-2xl font-bold text-gray-900'>Hospital Tie ups</h1>
            <p className='text-sm text-gray-500'>Manage your hospital's information</p>
          </div>
          <div className='page-header-actions'>
          {!editing ? (
            <button onClick={() => setEditing(true)}
              className='w-full sm:w-auto px-4 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-sm font-semibold rounded-xl shadow transition-all'>
              Edit details
            </button>
          ) : (
